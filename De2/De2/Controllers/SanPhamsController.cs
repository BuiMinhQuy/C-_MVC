...
namespace De2.Controllers
{
    ...
    {
        private PhanCongDuy_Context db = new PhanCongDuy_Context();
        ...
        public ActionResult RenderMenu()
        {
            ...
            return PartialView("PhanCongDuy_PhanLoaiPhu", phanLoaiPhus);
        }

        public ActionResult RenderProduct()
        {
            List<SanPham> sanPhams = db.SanPhams.ToList();
            return PartialView("PhanCongDuy_MainContent", sanPhams);
        }

        public ActionResult RenderProductAjax(string SpID)
        {
            List<SanPham> sanpham = db.SanPhams.Where(sp => sp.MaPhanLoaiPhu == SpID).ToList();
            return PartialView("PhanCongDuy_MainContent", sanpham);
        }
